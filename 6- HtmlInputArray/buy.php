...
if($_SERVER['REQUEST_METHOD'] == "GET"){
    ...
    http_response_code(405);die; //status code
}
...
<div class="container">
    <div class="row mt-5">
        ...
        <?php for($counter = 0; $counter < $_POST['members_number'];$counter++): ?>
        <div class="col-4">
            <div class="member1">
        ...
        <?php endfor ?>
        <div class="col-12">
            <button class="btn btn-primary form-control" name="submit"> Choose </button>
        </div>
    </div>
</div>
</form>
